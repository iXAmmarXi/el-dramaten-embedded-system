...
void T1powerUpInitPWM(void){//uint16_t ch
...
void T1setPWMmotorB(int throttel){
    /*Adjust the value of PWM-signal by procentage*/
    if (throttel > 55 /*50*/) {
       timer_channel_output_pulse_value_config(TIMER1,TIMER_CH_0,((throttel-50)*2)*20);
       timer_channel_output_pulse_value_config(TIMER1,TIMER_CH_1,0);
    } else if (throttel < 45 /*50*/) {
       timer_channel_output_pulse_value_config(TIMER1,TIMER_CH_0,0);
       timer_channel_output_pulse_value_config(TIMER1,TIMER_CH_1,((50-throttel)*2)*20);
    } else {
       timer_channel_output_pulse_value_config(TIMER1,TIMER_CH_0,0);
       timer_channel_output_pulse_value_config(TIMER1,TIMER_CH_1,0);
    }
